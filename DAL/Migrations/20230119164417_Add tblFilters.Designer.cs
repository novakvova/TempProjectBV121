...
namespace DAL.Migrations
{
    ...
    [Migration("20230119164417_Add tblFilters")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Data.Entities.FilterEntity", b =>
                {
            ...
            modelBuilder.Entity("DAL.Data.Entities.FilterNameGroupEntity", b =>
                {
                    b.Property<int>("FilterNameId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DAL.Data.Entities.FilterValueEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DAL.Data.Entities.FilterEntity", b =>
                {
                    b.HasOne("DAL.Data.Entities.FilterNameEntity", "FilterName")
                        .WithMany()
                        .HasForeignKey("FilterNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Data.Entities.FilterValueEntity", "FilterValue")
                        .WithMany()
